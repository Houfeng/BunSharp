...
Delegate parameters are not treated as stable exports. If you need to retain an incoming delegate, store it explicitly or use `JSFunctionRef` when the original JS function identity matters.
